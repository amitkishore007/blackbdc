...
static const int64 nTargetTimespan = 1 * 12 * 60 * 60; // BlackDiamondCoin: 12 hours
static const int64 nTargetSpacing = 60; // BlackDiamondCoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6a16ca36ae9ff00820fb3911f1a49a591ad9a4355cbc4cd0fc55394b172d1a1e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1503512902; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1458165;

        if (fTestNet)
        {
            block.nTime    = 1503512902;
            block.nNonce   = 1458165;
        }
